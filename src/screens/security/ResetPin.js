    ...
    <View style={styles.container}>
      <View style={styles.containerPrimary}>
        <Text style={styles.heading}>
          To Reset your Transaction PIN, enter the 4 digit OTP sent to your
          mobile number.
        </Text>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput
            style={[
              styles.input,
              { borderColor: active3 ? COLORS.primary : COLORS.inputBorder },
            ]}
            maxLength={1}
            keyboardType="number-pad"
        ...
        <View style={{flexDirection: 'row', justifyContent: 'center'}}>
          ...
          <TouchableOpacity  style={{marginLeft: 6}}>
            <Text style={{ fontWeight: "bold", color: '#0B535B' }}>Resend</Text>
          </TouchableOpacity>
        </View>
